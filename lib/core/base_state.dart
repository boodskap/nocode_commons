...
String imageUrl(String baseUrl, String domainKey, String id) {
  return '$baseUrl/Image/download/$domainKey/$id';
}

String twinImageUrl(String baseUrl, String domainKey, String id) {
  return '$baseUrl/TwinImage/download/$domainKey/$id';
}
