...
import '../custom/widgets/fillable_circle.dart';
import '../custom/widgets/fillable_rectangle.dart';
import 'alarm_snippet.dart';
import 'display_snippet.dart';
  ...
  void setup() async {
    ...
    if (null == deviceImage) {
      ...
      if (null != _customWidget) {
        ...
        deviceImage ??= Image.network(twinImageUrl(
