...
class CorkedBottleSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const CorkedBottleSettings(
      {super.key,
      required this.label,
  ...
  @override
  State<CorkedBottleSettings> createState() => _CorkedBottleSettingsState();
}

class _CorkedBottleSettingsState extends State<CorkedBottleSettings> {
  @override
      ...
      children: [
        SizedBox(
          ...
          child: CorkedBottle(
            ...
            capColor: Color(widget.settings['capColor'] ?? Colors.grey.value),
        ...
        Column(
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('Cork Color'),
                IconButton(
                    onPressed: () async {
                      Color? picked = await pickColor(
                          selectedColor: Color(widget.settings['capColor'] ??
                              Colors.grey.value));
                      setState(() {
                        widget.settings['capColor'] =
                            picked?.value ?? Colors.grey.value;
                      });
                    },
                    icon: Icon(
                      Icons.palette,
                      color: Color(
                          widget.settings['capColor'] ?? Colors.grey.value),
                    )),
              ],
            ),
            const SizedBox(
