...
class RoofTopTankSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const RoofTopTankSettings(
      {super.key,
  ...
  @override
  State<RoofTopTankSettings> createState() => _RoofTopTankSettingsState();
}

class _RoofTopTankSettingsState extends State<RoofTopTankSettings> {
  @override
