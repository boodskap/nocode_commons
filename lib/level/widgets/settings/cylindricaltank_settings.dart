...
class CylindricalTankSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const CylindricalTankSettings(
      {super.key,
  ...
  @override
  State<CylindricalTankSettings> createState() =>
      _CylindricalTankSettingsState();
}

class _CylindricalTankSettingsState extends State<CylindricalTankSettings> {
  @override
