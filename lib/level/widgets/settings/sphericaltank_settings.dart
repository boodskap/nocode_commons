...
class SphericalTankSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const SphericalTankSettings(
      {super.key,
  ...
  @override
  State<SphericalTankSettings> createState() => _SphericalTankSettingsState();
}

class _SphericalTankSettingsState extends State<SphericalTankSettings> {
  @override
      ...
      children: [
        SizedBox(
          ...
          child: SphericalTank(
            ...
            label: widget.label,
            liquidLevel: 35,
            breakpoint: widget.settings['breakpoint'] ?? 3,
          ),
        ),
        Column(
          children: [
