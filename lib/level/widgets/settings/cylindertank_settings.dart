...
class CylinderTankSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const CylinderTankSettings(
      {super.key,
  ...
  @override
  State<CylinderTankSettings> createState() => _CylinderTankSettingsState();
}

class _CylinderTankSettingsState extends State<CylinderTankSettings> {
  @override
