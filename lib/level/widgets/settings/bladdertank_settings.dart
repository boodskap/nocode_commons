...
class BladderTankSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const BladderTankSettings(
      {super.key,
  ...
  @override
  State<BladderTankSettings> createState() => _BladderTankSettingsState();
}

class _BladderTankSettingsState extends State<BladderTankSettings> {
  @override
