...
class RectangularTankSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const RectangularTankSettings(
      {super.key,
  ...
  @override
  State<RectangularTankSettings> createState() =>
      _RectangularTankSettingsState();
}

class _RectangularTankSettingsState extends State<RectangularTankSettings> {
  @override
