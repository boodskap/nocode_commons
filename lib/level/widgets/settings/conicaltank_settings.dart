...
class ConicalTankSettings extends StatefulWidget {
  final String label;
  ...
  @override
  State<ConicalTankSettings> createState() => _ConicalTankSettingsState();
}

class _ConicalTankSettingsState extends State<ConicalTankSettings> {
  @override
        ...
        SizedBox(
          ...
          child: ConicalTank(
            ...
            fontWeight: widget.settings['fontBold'] ?? true
                ? FontWeight.bold
                : FontWeight.normal,
            breakpoint: widget.settings['breakpoint'] ?? 1.2,
            smoothCorner: widget.settings['smoothCorner'] ?? true,
            label: widget.label,
            liquidLevel: 35,
          ),
        ),
        Column(
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('Smooth Corner'),
                Checkbox(
                  value: widget.settings['smoothCorner'] ?? true,
                  onChanged: (value) =>
                      setState(() => widget.settings['smoothCorner'] = value),
                )
              ],
            ),
            const SizedBox(
