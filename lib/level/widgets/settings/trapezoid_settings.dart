...
class TrapezoidTankSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const TrapezoidTankSettings(
      {super.key,
  ...
  @override
  State<TrapezoidTankSettings> createState() => _TrapezoidTankSettingsState();
}

class _TrapezoidTankSettingsState extends State<TrapezoidTankSettings> {
  @override
