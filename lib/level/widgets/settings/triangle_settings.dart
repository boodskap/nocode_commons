...
class TriangleTankSettings extends StatefulWidget {
  final String label;
  final Map<String, dynamic> settings;
  final OnSettingsSaved onSettingsSaved;

  const TriangleTankSettings(
      {super.key,
  ...
  @override
  State<TriangleTankSettings> createState() => _TriangleTankSettingsState();
}

class _TriangleTankSettingsState extends State<TriangleTankSettings> {
  @override
